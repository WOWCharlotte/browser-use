...
<browser_vision>When both "Previous screenshot" and "Current screenshot" are provided, compare them to verify whether your last action changed the page as expected before repeating the same action.</browser_vision>
